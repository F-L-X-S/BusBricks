...
template$<$typename interface\+\_\+type $>$ \\
void \mbox{\hyperlink{class_comm_interface}{Comm\+Interface}}$<$ interface\+\_\+type $>$\+::get\+Received\+Frame (\begin{DoxyParamCaption}\item[{String \texorpdfstring{$\ast$}{*}}]{dest\+Frame\+Buffer}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
template$<$typename interface\+\_\+type $>$ \\
void \mbox{\hyperlink{class_comm_interface}{Comm\+Interface}}$<$ interface\+\_\+type $>$\+::send\+New\+Frame (\begin{DoxyParamCaption}\item[{String \texorpdfstring{$\ast$}{*}}]{send\+Frame}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
