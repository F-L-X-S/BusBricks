...
\begin{DoxyCompactList}\small\item\em Add items from the send\+Stack to the comm\+\_\+interface and execute the send\+Cycle of \doxylink{class_comm_interface}{Comm\+Interface} delete the sent item from the send\+Stack. \end{DoxyCompactList}\item 
